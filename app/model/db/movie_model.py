...
class Magnet(Base):
    ...
    mid = Column(String(16, 'utf8mb4_unicode_ci'), nullable=False, server_default=text("'0'"), comment='关联的电影ID')
...
class Movie(Base):
    ...
    studio_id = Column(INTEGER, nullable=False, server_default=text("'0'"), comment='制作商Id')
...
class MovieDirector(Base):
    ...
    director_id = Column(INTEGER, nullable=False, comment='导演Id')
    created_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP"), comment='创建时间')
    updated_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"),
                        comment='更新时间')
...
class MovieGenre(Base):
    ...
    id = Column(INTEGER, primary_key=True, comment='自增主键Id')
    movie_id = Column(INTEGER, nullable=False, comment='电影Id')
    genre_id = Column(INTEGER, nullable=False, comment='类别Id')
    created_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP"), comment='创建时间')
    updated_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"),
                        comment='更新时间')
...
class MovieLabel(Base):
    ...
    id = Column(INTEGER, primary_key=True, comment='自增主键Id')
    movie_id = Column(INTEGER, nullable=False, comment='电影Id')
    label_id = Column(INTEGER, nullable=False, comment='标签Id')
    created_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP"), comment='创建时间')
    updated_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"),
                        comment='更新时间')
...
class MovieSery(Base):
    ...
    id = Column(INTEGER, primary_key=True, comment='自增主键Id')
    movie_id = Column(INTEGER, nullable=False, comment='电影Id')
    series_id = Column(INTEGER, nullable=False, comment='系列Id')
    created_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP"), comment='创建时间')
    updated_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"),
                        comment='更新时间')
...
class MovieStar(Base):
    ...
    id = Column(INTEGER, primary_key=True, comment='自增主键Id')
    movie_id = Column(INTEGER, nullable=False, comment='电影Id')
    star_id = Column(INTEGER, nullable=False, comment='演员Id')
    created_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP"), comment='创建时间')
    updated_at = Column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"),
                        comment='更新时间')
